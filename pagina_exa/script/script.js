function createFlower() {
    ...
    // Verificar si ya hay 15 flores en pantalla
    ...
    for (let j = 0; j < maxFlowers; j++) {
        ...
        while (!positionValid) {
            ...
            for (const position of existingPositions) {
                ...
                if (distance < 100) { // Rango de 100 píxeles
                    positionValid = false;
                    break;
                }
            }
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            petal.style.animation = `fadeOutPetal 0.5s ease-in-out both ${i * 0.1}s, fadeOutPetal 0.5s ease-in-out both ${disappearanceTime}s`;
        }
...
setInterval(createFlower, 1000); // Nuevas flores cada segundo
